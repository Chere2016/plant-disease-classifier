...
echo "Starting Experiment 3 (Regularized) in the background on GPU 1..."
nohup python src/train.py --config configs/train_config_exp3.yaml > logs/train_output_exp3.log 2>&1 &

echo "Success! The script is running."
echo "You can watch the live terminal output by running:"
echo "tail -f logs/train_output_exp3.log"
